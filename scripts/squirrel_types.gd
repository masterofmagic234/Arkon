...
const TYPES := {
    Kind.SCOUT: {"name":"Разведчик", "hp":2, "speed":3.4, "attack_distance":1.0, "damage":12, "panic_radius":4.0, "flees":false},
    Kind.THROWER: {"name":"Стрелок", "hp":1, "speed":1.2, "attack_distance":5.5, "damage":8, "panic_radius":2.5, "flees":false},
    Kind.TANK: {"name":"Танк", "hp":4, "speed":1.8, "attack_distance":1.1, "damage":18, "panic_radius":0.0, "flees":false},
